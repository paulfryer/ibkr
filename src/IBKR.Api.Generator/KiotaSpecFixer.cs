...
/// <summary>
/// Fixes known issues in the IBKR OpenAPI specification specifically for Kiota generation.
/// See OPENAPI_ERRORS.md for detailed documentation of each fix.
/// </summary>
public class KiotaSpecFixer
{
    private readonly OpenApiDocument _document;
    private int _fixesApplied = 0;

    public KiotaSpecFixer(OpenApiDocument document)
    {
        _document = document;
    }
    ...
    {
        Console.WriteLine("\n=== Applying Kiota-Specific OpenAPI Spec Fixes ===\n");
    ...
    ///
    /// Kiota, like NSwag, needs the paths to include the full route. Instead of changing
