...
public partial class FyiService : IFyiService
{
    ...
    public virtual async System.Threading.Tasks.Task DeliveryoptionsDELETEAsync(object deviceId,
    ...
    public virtual async Task<DeliveryOptions> DeliveryoptionsGETAsync(CancellationToken cancellationToken = default)
    {
        var client_ = _httpClient;
        var disposeClient_ = false;
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_ =
                            await ReadObjectResponseAsync<DeliveryOptions>(response_, headers_, cancellationToken)
    ...
    public virtual async Task<FyiVT> DeviceAsync(FyiEnableDeviceOption body,
        CancellationToken cancellationToken = default)
    {
    ...
    public virtual async Task<DisclaimerInfo> DisclaimerGETAsync(Typecodes typecode,
        CancellationToken cancellationToken = default)
    {
        var client_ = _httpClient;
        var disposeClient_ = false;
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_ =
                            await ReadObjectResponseAsync<DisclaimerInfo>(response_, headers_, cancellationToken)
                                .ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_.Text, headers_, null);
    ...
    public virtual async Task<FyiVT> DisclaimerPUTAsync(Typecodes typecode,
        CancellationToken cancellationToken = default)
    {
        var client_ = _httpClient;
        var disposeClient_ = false;
    ...
    public virtual async Task<FyiVT> EmailAsync(object enabled, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            urlBuilder_.Append('?');
            urlBuilder_.Append(Uri.EscapeDataString("enabled")).Append('=')
                .Append(Uri.EscapeDataString(ConvertToString(enabled, CultureInfo.InvariantCulture)))
                .Append('&');
            urlBuilder_.Length--;
            var url_ = urlBuilder_.ToString();
            request_.RequestUri = new Uri(url_, UriKind.RelativeOrAbsolute);
    ...
    public virtual async Task<ICollection<Anonymous>> NotificationsAllAsync(string max, object? include = null,
        object? exclude = null, object? id = null, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            urlBuilder_.Append('?');
            urlBuilder_.Append(Uri.EscapeDataString("max")).Append('=')
                .Append(Uri.EscapeDataString(ConvertToString(max, CultureInfo.InvariantCulture)))
                .Append('&');
            if (include != null)
                urlBuilder_.Append(Uri.EscapeDataString("include")).Append('=')
                    .Append(Uri.EscapeDataString(ConvertToString(include, CultureInfo.InvariantCulture)))
                    .Append('&');
            if (exclude != null)
                urlBuilder_.Append(Uri.EscapeDataString("exclude")).Append('=')
                    .Append(Uri.EscapeDataString(ConvertToString(exclude, CultureInfo.InvariantCulture)))
                    .Append('&');
            if (id != null)
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_5 =
                            await ReadObjectResponseAsync<ICollection<Anonymous>>(response_, headers_,
    ...
    public virtual async Task<NotificationReadAcknowledge> NotificationsAsync(object notificationId,
        CancellationToken cancellationToken = default)
    {
        if (notificationId == null) throw new ArgumentNullException("notificationId");
        var client_ = _httpClient;
        var disposeClient_ = false;
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_5 =
                            await ReadObjectResponseAsync<NotificationReadAcknowledge>(response_, headers_,
                                cancellationToken).ConfigureAwait(false);
                        if (objectResponse_5.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_5.Text, headers_, null);
    ...
    public virtual async Task<ICollection<Anonymous2>> SettingsAllAsync(CancellationToken cancellationToken = default)
    {
        var client_ = _httpClient;
        var disposeClient_ = false;
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_ =
                            await ReadObjectResponseAsync<ICollection<Anonymous2>>(response_, headers_,
                                cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_.Text, headers_, null);
    ...
    public virtual async Task<FyiVT> SettingsAsync(Typecodes typecode, Body body,
        CancellationToken cancellationToken = default)
    {
        if (body == null) throw new ArgumentNullException("body");
        var client_ = _httpClient;
    ...
    public virtual async Task<Response> UnreadnumberAsync(CancellationToken cancellationToken = default)
    {
        var client_ = _httpClient;
        var disposeClient_ = false;
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_5 =
                            await ReadObjectResponseAsync<Response>(response_, headers_, cancellationToken)
                                .ConfigureAwait(false);
                        if (objectResponse_5.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_5.Text, headers_, null);
                    ...
                    case 423:
                    {
                        var objectResponse_3 =
                            await ReadObjectResponseAsync<Response25>(response_, headers_, cancellationToken)
                                .ConfigureAwait(false);
                        if (objectResponse_3.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_3.Text, headers_, null);
                        throw new ApiException<Response25>(
                            "Return if called too frequently. Should not be called more than 1 time in 5 minutes",
