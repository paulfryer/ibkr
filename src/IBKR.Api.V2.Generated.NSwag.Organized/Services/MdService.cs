...
public partial class MdService : IMdService
{
    ...
    public MdService(HttpClient httpClient)
    {
    ...
    public virtual async Task<RegsnapshotData> RegsnapshotAsync(string conid,
                ...
                switch (status_)
                {
                    case 200:
                    {
                        var objectResponse_5 =
                            await ReadObjectResponseAsync<RegsnapshotData>(response_, headers_, cancellationToken)
