...
public partial class HmdsService : IHmdsService
{
    ...
    public HmdsService(HttpClient httpClient)
    {
    ...
    public virtual async Task<HmdsHistoryResponse> HistoryAsync(string conid, string period, string bar,
        BarType? barType = null, string? startTime = null, string? direction = null, bool? outsideRth = null,
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            urlBuilder_.Append(Uri.EscapeDataString("bar")).Append('=')
                ...
                .Append('&');
            if (barType.HasValue)
                urlBuilder_.Append(Uri.EscapeDataString("barType")).Append('=')
                    .Append(Uri.EscapeDataString(ConvertToString(barType, CultureInfo.InvariantCulture)))
                    .Append('&');
            if (startTime != null)
                urlBuilder_.Append(Uri.EscapeDataString("startTime")).Append('=')
                    ...
                    .Append('&');
            if (direction != null)
                urlBuilder_.Append(Uri.EscapeDataString("direction")).Append('=')
                    .Append(Uri.EscapeDataString(ConvertToString(direction, CultureInfo.InvariantCulture)))
                    .Append('&');
                ...
                switch (status_)
                {
                    case 200:
                    {
                        var objectResponse_5 =
                            await ReadObjectResponseAsync<HmdsHistoryResponse>(response_, headers_, cancellationToken)
    ...
    public virtual async Task<HmdsScannerParams> ParamsAsync(CancellationToken cancellationToken = default)
    {
        var client_ = _httpClient;
        var disposeClient_ = false;
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_5 =
                            await ReadObjectResponseAsync<HmdsScannerParams>(response_, headers_, cancellationToken)
                                .ConfigureAwait(false);
                        if (objectResponse_5.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_5.Text, headers_, null);
    ...
    public virtual async Task<Response6> RunAsync(HmdsScannerRunRequest body,
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_ =
                            await ReadObjectResponseAsync<Response6>(response_, headers_, cancellationToken)
                                .ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                            throw new ApiException("Response was null which was not expected.", status_,
                                objectResponse_.Text, headers_, null);
                    ...
                    case 404:
                    {
                        ...
                        throw new ApiException("Returned on the first successful request. Used as a preflight message.",
