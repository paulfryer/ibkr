...
/// <summary>
///     Implementation of AceswsService
/// </summary>
[GeneratedCode("NSwag", "14.0.3.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class AceswsService : IAceswsService
{
    private readonly string _baseUrl;
    private readonly HttpClient _httpClient;
    private readonly Lazy<JsonSerializerSettings> _settings;

    public AceswsService(HttpClient httpClient)
    {
    ...
    public virtual async Task<SignatureAndOwners> SignaturesAndOwnersAsync(string accountId,
        ...
        try
        {
            ...
            try
            {
                ...
                switch (status_)
                {
                    ...
                    {
                        var objectResponse_ =
                            await ReadObjectResponseAsync<SignatureAndOwners>(response_, headers_, cancellationToken)
                    ...
                    case 400:
                    {
                        ...
                        throw new ApiException<ErrorResponse>("bad request; accountId is empty", status_,
