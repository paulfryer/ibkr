...
public partial class TickleService : ITickleService
{
    ...
    public virtual async Task<SuccessfulTickleResponse> TickleAsync(CancellationToken cancellationToken = default)
    {
                ...
                switch (status_)
                {
                    case 200:
                    {
                        var objectResponse_2 =
                            await ReadObjectResponseAsync<SuccessfulTickleResponse>(response_, headers_,
