...
{
    [EnumMember(Value = "Account_Holder")] Account_Holder,
    [EnumMember(Value = "Spouse")] Spouse,
    [EnumMember(Value = "Firstholder")] Firstholder,
    [EnumMember(Value = "Secondholder")] Secondholder,
    ...
    [EnumMember(Value = "Superv_Broker")] Superv_Broker,
    [EnumMember(Value = "Pooled_User")] Pooled_User,
    [EnumMember(Value = "Financial_User")] Financial_User,
    [EnumMember(Value = "Contingent")] Contingent,

    [EnumMember(Value = "Ira_Beneficiary")]
    Ira_Beneficiary,
    [EnumMember(Value = "Employee")] Employee,
    [EnumMember(Value = "Non_Employee")] Non_Employee,
    [EnumMember(Value = "Fund_Admin")] Fund_Admin,
    [EnumMember(Value = "Fund_Contact")] Fund_Contact,
    [EnumMember(Value = "Firm_Admin")] Firm_Admin,
    [EnumMember(Value = "Firm_Billing")] Firm_Billing,
    [EnumMember(Value = "Firm_Clearing")] Firm_Clearing,
    [EnumMember(Value = "Firm_Sales")] Firm_Sales,
    [EnumMember(Value = "Firm_Trading")] Firm_Trading,
    [EnumMember(Value = "Firm_User")] Firm_User,
    [EnumMember(Value = "Account_Admin")] Account_Admin,
    ...
    Account_Clearing,
    [EnumMember(Value = "Account_Sales")] Account_Sales,
    ...
    User_Individual,
    [EnumMember(Value = "Fund_Manager")] Fund_Manager,
    ...
    Compliance_Officer,
    [EnumMember(Value = "Other_Officer")] Other_Officer,
    [EnumMember(Value = "Apply_User")] Apply_User,
    ...
    Nominee_Guardian,
    [EnumMember(Value = "Ira_Decedent")] Ira_Decedent,

    [EnumMember(Value = "Authorized_Person")]
    Authorized_Person,
    [EnumMember(Value = "Promoter")] Promoter,

    [EnumMember(Value = "Wholetime_Director")]
    Wholetime_Director,
    [EnumMember(Value = "Nominee_Owner")] Nominee_Owner,
    ...
    [EnumMember(Value = "Mm_Contact")] Mm_Contact,
    [EnumMember(Value = "Reg_Rep")] Reg_Rep,
    [EnumMember(Value = "Plan_Sponsor")] Plan_Sponsor,

    [EnumMember(Value = "Plan_Sponsor_Officer")]
    Plan_Sponsor_Officer,
    [EnumMember(Value = "Pension_Admin")] Pension_Admin,
    ...
    [EnumMember(Value = "Estate")] Estate,
    ...
    [EnumMember(Value = "Life_Partner")] Life_Partner,

    [EnumMember(Value = "Common_Law_Partner")]
    Common_Law_Partner,
    [EnumMember(Value = "Grandchild")] Grandchild,
    [EnumMember(Value = "Charity")] Charity,
    [EnumMember(Value = "Trust_Ira")] Trust_Ira,

    [EnumMember(Value = "Successor_Holder")]
    Successor_Holder,
    [EnumMember(Value = "Head_Of_Desk")] Head_Of_Desk,
