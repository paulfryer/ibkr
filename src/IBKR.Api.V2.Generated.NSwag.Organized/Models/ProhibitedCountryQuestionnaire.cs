...
public class ProhibitedCountryQuestionnaire
{
    ...
    [JsonProperty("prohibitedQuestionnaireDetails", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public ICollection<ProhibitedQuestionnaireDetail> ProhibitedQuestionnaireDetails { get; set; }
