...
public class Document
{
    ...
    [Required]
    public AttachedFileType AttachedFile { get; set; } = new();
    ...
    public int ExecLoginTimestamp { get; set; }

    [JsonProperty("execTimestamp", Required = Required.Always)]
    public int ExecTimestamp { get; set; }
    ...
    [JsonProperty("proofOfIdentityType", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    [JsonConverter(typeof(StringEnumConverter))]
