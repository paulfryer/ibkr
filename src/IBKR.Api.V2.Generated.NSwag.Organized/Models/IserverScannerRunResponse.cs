...
public class IserverScannerRunResponse
{
	...
	[JsonProperty("scan_data_column_name", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public string Scan_data_column_name { get; set; } = null;
