...
public enum IraDepositDetailFromIraType
{
    ...
    [EnumMember(Value = "ROLLOVER")] ROLLOVER,
    [EnumMember(Value = "ROTH")] ROTH,
    [EnumMember(Value = "SEP")] SEP,
    [EnumMember(Value = "EDUCATION")] EDUCATION,

    [EnumMember(Value = "TRADITIONAL_INHERITED")]
    TRADITIONAL_INHERITED,
    [EnumMember(Value = "ROTH_INHERITED")] ROTH_INHERITED,
    [EnumMember(Value = "SEP_INHERITED")] SEP_INHERITED,
