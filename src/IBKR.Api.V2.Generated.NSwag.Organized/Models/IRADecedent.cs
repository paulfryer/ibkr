...
public class IRADecedent
{
	...
	public IRADecedentGender Gender { get; set; } = IRADecedentGender.M;

	[JsonProperty("maritalStatus", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	[JsonConverter(typeof(StringEnumConverter))]
	public IRADecedentMaritalStatus MaritalStatus { get; set; } = IRADecedentMaritalStatus.S;
	...
	public DateTimeOffset DateOfDeath { get; set; } = default(DateTimeOffset);

	[JsonProperty("title", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public Title Title { get; set; } = null;

	[JsonProperty("inheritorType", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	[JsonConverter(typeof(StringEnumConverter))]
	public IRADecedentInheritorType InheritorType { get; set; } = IRADecedentInheritorType.S;

	[JsonProperty("relationship", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	[JsonConverter(typeof(StringEnumConverter))]
	public IRADecedentRelationship Relationship { get; set; } = IRADecedentRelationship.Other;
