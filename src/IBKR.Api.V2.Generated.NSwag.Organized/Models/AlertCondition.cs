...
public class AlertCondition
{
    ...
    [JsonProperty("condition_trigger_method", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public int Condition_trigger_method { get; set; }
    ...
    [JsonProperty("condition_logic_bind", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public bool Condition_logic_bind { get; set; }

    [JsonProperty("condition_time_zone", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public string Condition_time_zone { get; set; }
