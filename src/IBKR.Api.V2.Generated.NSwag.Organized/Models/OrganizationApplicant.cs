...
public class OrganizationApplicant
{
    ...
    public ICollection<OrganizationIdentification> Identifications { get; set; }

    [JsonProperty("accountSupport", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
    public AccountSupportType AccountSupport { get; set; }
    ...
    public ManagingOwner ManagingOwner { get; set; }
    ...
    public bool OrgUsSubsidiary { get; set; }

    [JsonProperty("qualifiedIntermediary", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public bool QualifiedIntermediary { get; set; }

    [JsonProperty("assumedPrimaryReporting", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public bool AssumedPrimaryReporting { get; set; }

    [JsonProperty("acceptedPrimaryWithholding", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public bool AcceptedPrimaryWithholding { get; set; }

    [JsonProperty("usTaxPurposeType", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
    [JsonConverter(typeof(StringEnumConverter))]
    public OrganizationApplicantUsTaxPurposeType UsTaxPurposeType { get; set; } =
        OrganizationApplicantUsTaxPurposeType.C;
