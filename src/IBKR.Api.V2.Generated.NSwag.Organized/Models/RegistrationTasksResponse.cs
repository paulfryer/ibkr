...
public class RegistrationTasksResponse
{
	...
	[JsonProperty("registrationTaskPresent", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public bool RegistrationTaskPresent { get; set; } = false;

	[JsonProperty("registrationTasks", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public ICollection<RegistrationTask> RegistrationTasks { get; set; } = null;
