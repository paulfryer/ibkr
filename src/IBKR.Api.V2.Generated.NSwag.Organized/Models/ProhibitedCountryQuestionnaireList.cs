...
public class ProhibitedCountryQuestionnaireList
{
	...
	[JsonProperty("prohibitedQuestionnaireDetail", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public ICollection<ProhibitedQuestionnaireDetail> ProhibitedQuestionnaireDetail { get; set; } = null;
