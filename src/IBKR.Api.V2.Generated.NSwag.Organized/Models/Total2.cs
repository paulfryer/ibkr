...
public class Total2
{
    ...
    [JsonProperty("Nt Lqdtn Uncrtnty", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
    public string Nt_Lqdtn_Uncrtnty { get; set; }

    [JsonProperty("equity_with_loan", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
    public string Equity_with_loan { get; set; }

    [JsonProperty("Prvs Dy Eqty Wth Ln Vl", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public string Prvs_Dy_Eqty_Wth_Ln_Vl { get; set; }

    [JsonProperty("sec_gross_pos_val", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
    public string Sec_gross_pos_val { get; set; }
    ...
    [JsonProperty("Pndng Dbt Crd Chrgs", Required = Required.DisallowNull,
        NullValueHandling = NullValueHandling.Ignore)]
    public string Pndng_Dbt_Crd_Chrgs { get; set; }
