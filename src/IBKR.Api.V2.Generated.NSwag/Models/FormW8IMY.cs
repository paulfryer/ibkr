...
public class FormW8IMY
{
	...
	[JsonProperty("countryOfIncorporation", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	...
	public bool Part314B { get; set; } = false;
