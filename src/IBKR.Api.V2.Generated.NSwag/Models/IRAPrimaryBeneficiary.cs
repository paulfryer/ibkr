...
public class IRAPrimaryBeneficiary
{
	...
	public IRAPrimaryBeneficiaryGender Gender { get; set; } = IRAPrimaryBeneficiaryGender.M;


	[JsonProperty("maritalStatus", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	[JsonConverter(typeof(StringEnumConverter))]
	public IRAPrimaryBeneficiaryMaritalStatus MaritalStatus { get; set; } = IRAPrimaryBeneficiaryMaritalStatus.S;
	...
	[JsonConverter(typeof(StringEnumConverter))]
	public IRAPrimaryBeneficiaryRelationship Relationship { get; set; } = IRAPrimaryBeneficiaryRelationship.Brother;
