...
public class AssociatedIndividual
{
	...
	public AssociatedIndividualGender Gender { get; set; } = AssociatedIndividualGender.M;


	[JsonProperty("maritalStatus", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	[JsonConverter(typeof(StringEnumConverter))]
	public AssociatedIndividualMaritalStatus MaritalStatus { get; set; } = AssociatedIndividualMaritalStatus.S;
	...
	[JsonProperty("titles", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public ICollection<Title> Titles { get; set; } = null;


	[JsonProperty("authorizedPerson", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public bool AuthorizedPerson { get; set; } = false;
