...
public class ChangeFinancialInformation
{
	...
	[JsonProperty("newFinancialInformation", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
	public FinancialInformation NewFinancialInformation { get; set; } = null;
