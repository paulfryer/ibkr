...
{
	[EnumMember(Value = "Account Holder")]
	Account_Holder,
	[EnumMember(Value = "FIRST HOLDER")]
	FIRST_HOLDER,
	[EnumMember(Value = "SECOND HOLDER")]
	SECOND_HOLDER,
