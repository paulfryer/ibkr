...
#nullable restore
        ...
        public global::IBKR.Api.Kiota.Models.AccountAttributes_businessType? BusinessType { get; set; }
        ...
        public global::IBKR.Api.Kiota.Models.AccountAttributes_clearingStatus? ClearingStatus { get; set; }
        /// <summary>Indicates a Covestor account.</summary>
        public bool? Covestor { get; set; }
        /// <summary>Base currency of the account.</summary>
        public global::IBKR.Api.Kiota.Models.AccountAttributes_currency? Currency { get; set; }
...
#nullable restore
        ...
        public global::IBKR.Api.Kiota.Models.AccountAttributes_ibEntity? IbEntity { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::IBKR.Api.Kiota.Models.AccountAttributes_parent? Parent { get; set; }
#nullable restore
#else
        public global::IBKR.Api.Kiota.Models.AccountAttributes_parent Parent { get; set; }
#endif
        ...
        public global::IBKR.Api.Kiota.Models.AccountAttributes_tradingType? TradingType { get; set; }
        /// <summary>Indicates whether the account exists in production, paper, or demo environments.</summary>
        public global::IBKR.Api.Kiota.Models.AccountAttributes_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::IBKR.Api.Kiota.Models.AccountAttributes"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::IBKR.Api.Kiota.Models.AccountAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::IBKR.Api.Kiota.Models.AccountAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::IBKR.Api.Kiota.Models.AccountAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "businessType", n => { BusinessType = n.GetEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_businessType>(); } },
                { "clearingStatus", n => { ClearingStatus = n.GetEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_clearingStatus>(); } },
                { "covestor", n => { Covestor = n.GetBoolValue(); } },
                { "currency", n => { Currency = n.GetEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_currency>(); } },
                { "desc", n => { Desc = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "faClient", n => { FaClient = n.GetBoolValue(); } },
                { "ibEntity", n => { IbEntity = n.GetEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_ibEntity>(); } },
                { "id", n => { Id = n.GetStringValue(); } },
                { "noClientTrading", n => { NoClientTrading = n.GetBoolValue(); } },
                { "parent", n => { Parent = n.GetObjectValue<global::IBKR.Api.Kiota.Models.AccountAttributes_parent>(global::IBKR.Api.Kiota.Models.AccountAttributes_parent.CreateFromDiscriminatorValue); } },
                ...
                { "tradingType", n => { TradingType = n.GetEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_tradingType>(); } },
                { "type", n => { Type = n.GetEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_businessType>("businessType", BusinessType);
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_clearingStatus>("clearingStatus", ClearingStatus);
            writer.WriteBoolValue("covestor", Covestor);
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_currency>("currency", Currency);
            writer.WriteStringValue("desc", Desc);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteBoolValue("faClient", FaClient);
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_ibEntity>("ibEntity", IbEntity);
            writer.WriteStringValue("id", Id);
            writer.WriteBoolValue("noClientTrading", NoClientTrading);
            writer.WriteObjectValue<global::IBKR.Api.Kiota.Models.AccountAttributes_parent>("parent", Parent);
            ...
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_tradingType>("tradingType", TradingType);
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.AccountAttributes_type>("type", Type);
