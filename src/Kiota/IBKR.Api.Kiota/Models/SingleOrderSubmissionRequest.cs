...
#nullable restore
        ...
        public global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_side? Side { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_strategyParameters? StrategyParameters { get; set; }
#nullable restore
#else
        public global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_strategyParameters StrategyParameters { get; set; }
#endif
...
#nullable restore
        ...
        public global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_tif? Tif { get; set; }
        ...
        public global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_trailingType? TrailingType { get; set; }
        /// <summary>Instructs IB to apply the Price Management Algo.</summary>
        public bool? UseAdaptive { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "side", n => { Side = n.GetEnumValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_side>(); } },
                { "strategy", n => { Strategy = n.GetStringValue(); } },
                { "strategyParameters", n => { StrategyParameters = n.GetObjectValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_strategyParameters>(global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_strategyParameters.CreateFromDiscriminatorValue); } },
                { "ticker", n => { Ticker = n.GetStringValue(); } },
                { "tif", n => { Tif = n.GetEnumValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_tif>(); } },
                { "trailingAmt", n => { TrailingAmt = n.GetDoubleValue(); } },
                { "trailingType", n => { TrailingType = n.GetEnumValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_trailingType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_side>("side", Side);
            writer.WriteStringValue("strategy", Strategy);
            writer.WriteObjectValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_strategyParameters>("strategyParameters", StrategyParameters);
            writer.WriteStringValue("ticker", Ticker);
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_tif>("tif", Tif);
            writer.WriteDoubleValue("trailingAmt", TrailingAmt);
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Models.SingleOrderSubmissionRequest_trailingType>("trailingType", TrailingType);
