...
using IBKR.Api.Kiota.Client.V1.Api;
...
using System;
namespace IBKR.Api.Kiota.Client.V1
{
    /// <summary>
    ...
    public partial class V1RequestBuilder : BaseRequestBuilder
    {
        ...
        public global::IBKR.Api.Kiota.Client.V1.Api.ApiRequestBuilder Api
        {
            get => new global::IBKR.Api.Kiota.Client.V1.Api.ApiRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::IBKR.Api.Kiota.Client.V1.V1RequestBuilder"/> and sets the default values.
        /// </summary>
