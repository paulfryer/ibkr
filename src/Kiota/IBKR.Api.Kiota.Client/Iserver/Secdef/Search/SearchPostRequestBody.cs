...
#nullable restore
        ...
        public global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody_secType? SecType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody"/> and sets the default values.
        /// </summary>
        public SearchPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            SecType = global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody_secType.STK;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "secType", n => { SecType = n.GetEnumValue<global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody_secType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::IBKR.Api.Kiota.Client.Client.Iserver.Secdef.Search.SearchPostRequestBody_secType>("secType", SecType);
