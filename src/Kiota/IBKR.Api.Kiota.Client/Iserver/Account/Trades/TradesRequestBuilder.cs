...
using System;
namespace IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::IBKR.Api.Kiota.Contract.Models.TradesResponse>?> GetAsync(Action<RequestConfiguration<global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder.TradesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::IBKR.Api.Kiota.Contract.Models.TradesResponse>> GetAsync(Action<RequestConfiguration<global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder.TradesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder.TradesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder.TradesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a list of trades, up to a maximum of 7 days prior.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TradesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::IBKR.Api.Kiota.Client.Client.Client.Client.Iserver.Account.Trades.TradesRequestBuilder.TradesRequestBuilderGetQueryParameters>
        {
        }
    }
}
